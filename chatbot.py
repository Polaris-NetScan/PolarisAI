...
def load_models():
    ...
    # Define Groq models
    GROQ_MODELS = ["llama3-8b-8192", "llama3-70b-8192", "mixtral-8x7b-32768", "gemma-7b-it", "gemma2-9b-it", "llama-3.1-70b-versatile", "llama-3.2-90b-text-preview"]

    model_type = st.selectbox("Select Large Language Model ⬇️", LLM_TYPES)
